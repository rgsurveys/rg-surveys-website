      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 bg-white rounded-lg header-shadow">
            ...
            <p className="mt-1 text-gray-600">Phone: 01234 567890</p>
            <p className="mt-4 text-gray-600">Office: RG Surveys HQ</p>
          </div>
          <div className="p-6 bg-white rounded-lg header-shadow">
            <h3 className="font-semibold">Office Location</h3>
            <p className="mt-2 text-gray-600">Use the map on the Get a Quote section for area selection.</p>
          </div>
        </div>
      </div>
    </section>
